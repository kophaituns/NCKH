...
import { getRoleDisplayName, canCreateSurveys, canManageUsers } from '../../utils/roleUtils.jsx';
...
const DashboardPage: React.FC = () => {
  ...
  const [recentSurveys] = useState([
    { id, title: 'IT Department Satisfaction Survey', responses, status: 'Active' },
    { id, title: 'Marketing Campaign Effectiveness', responses, status: 'Active' },
    { id, title: 'Economic Impact Assessment', responses, status: 'Completed' },
    { id, title: 'User Experience Feedback', responses, status: 'Draft' },
  ]);
